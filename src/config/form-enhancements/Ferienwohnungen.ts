// Auto-generated. Per-entity form-enhancements config for "Ferienwohnungen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['bezeichnung', 'max_personen', 'lage', 'beschreibung', 'hinweise'],
  defaults: {
    'max_personen': { kind: 'literal', value: 1 },
  },
  computed: {},
};
