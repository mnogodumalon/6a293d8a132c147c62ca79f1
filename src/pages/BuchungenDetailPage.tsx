...
export default function BuchungenDetailPage() {
  ...
  function getFerienwohnungenDisplayName(url?: unknown) {
    ...
    return ferienwohnungenList.find(r => r.record_id === refId)?.fields.bezeichnung ?? '—';
  }
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.gast_vorname ?? 'Buchungen'} />
      ...
      <RecordSection title="Details" cols={2}>
        <RecordField label="Ferienwohnung" value={getFerienwohnungenDisplayName(record.fields.ferienwohnung)} format="text" />
